...
\linenumbers
    ...
    \include{chap2/Backgroung}
    \include{chap2b/chap2b}
    \include{chap3/Experimental}
    \include{chap4/Transmem}
    \include{chap5/Results}
    \include{chap6/Conclusions}
    \appendix
        \include{App/Submited}
        \include{App/FAASFAES}
        \include{App/Tracker} 
        \include{App/Micro}
        \include{App/transmemManual}
